...
function DMObj() {}
DMObj.prototype.main = function(){alert("Did override DMObj.main() function")}
_cls["DMObj"] = DMObj
...
/*
dm.init = function(_DMClass, _default) {
    dm.method(_DMClass,"init", function(_args) {
        if (_args.DMClass == undefined) {
            if (_default.DMClass == undefined) {
                _args.DMClass = _DMClass
            } else {
                _args.DMClass = _default.DMClass
            }
        }
...
DMElement.prototype.init = function(obj$type_idNum_DMClass) {
...
DMElement.prototype.addRelativeWrap = function() { //addRelativeWrap() makes manipulating the position of child elements easier
    this.DMRelativeWrap = new DMElement({
        type: 'div',
        idNum: this.getID(),
